...
const pengembang = [
    {
        ...
        deskripsi: 'Syaugi merupakan Lead Full Stack Developer yang mengerjakan urusan Front-End dan Back-End aplikasi web ini. Kuliah di Politeknik Negeri Jember dan sedang mengerjakan skripsinya.',
    },
    {
        image: '/pp2.png',
        alt: 'Pengembang 2',
        ...
        <>
            ...
            <Container maxWidth="lg" sx={{ mt: { md: 18, xs: 9 } }}>
                <Box display="flex" justifyContent="space-between" sx={{ mx: 4, flexDirection: { md: 'row', xs: 'column' }, mb: 10 }}>
                    ...
                    <Box maxWidth={550} display="flex" flexDirection="column" justifyContent="space-evenly" sx={{ my: 3 }}>
                        <Box sx={{ my: 3 }}>
                            <Typography variant="h4" component="span" sx={{ color: '#EBFF00', fontFamily: 'Poppins', fontWeight: 'Bold', paddingBottom: '50px' }}>
                                Membantu
                            </Typography>
                            <Typography variant="h4" component="span" sx={{ fontFamily: 'Poppins', fontWeight: 'Bold' }}>
                        ...
                        >
                            MooCare memiliki tekad untuk dapat membantu peternak sapi agar dapat memahami kondisi peternakan mereka dengan bantuan teknologi. Sehingga mereka dapat mengelolanya dengan lebih baik lagi, terhidar dari berbagai
                            macam resiko kegagalan beternak serta meningkatkan produktivitasnya.
                        </Typography>
                ...
                <Container>
                    <Box display="flex" justifyContent="space-around" sx={{ flexDirection: { md: 'row', xs: 'column-reverse' }, py: 6 }}>
                        <Box maxWidth={550} display="flex" justifyContent="space-around" flexDirection="column">
                            <Typography variant="h4" component="span" sx={{ fontFamily: 'Poppins', color: 'black', fontWeight: 'Bold' }}>
                                Mengapa harus kami?
                            </Typography>
                            ...
                            >
                                Kami peduli dengan keberlangsungan dan kesejahteraan peternak sapi di Indonesia. Potensi daging dan susu sapi sangat tinggi di Indonesia sehingga dengan bantuan teknologi, kami harap produksi dan kualitas
                                daging dan susu sapi meningkat dan menambah daya saing peternak sapi Indonesia dalam skala global.
                            </Typography>
            ...
            <Container>
                <Box display="flex" justifyContent="center">
                    <Typography variant="h4" component="div" sx={{ fontFamily: 'Poppins', my: 3, paddingBottom: '20px' }}>
                        Tim Pengembang
                    </Typography>
                </Box>
                                ...
                                <Box display="flex" justifyContent="center">
                                    ...
                                    >
                                        <Box xs={{ height: '100%' }}>
                                            ...
                                            >
                                                <Image src={step.image} alt={step.nama} width={300} height={300} style={{ borderRadius: '100%', border: 'solid', padding: '2px' }} />
                                            </Box>
                                        </Box>
